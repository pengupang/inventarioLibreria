...
class FrameVerIngresarVentas():
    def __init__(self,ventana) -> None:
        ...
        label_cantidad = tk.Label(ventana, text="Cantidad Vendida:")
        label_total = tk.Label(ventana, text="Total venta:")
        ...
        self.tabla['columns'] = ("ID", "Titulo Libro", "Fecha", "Cantidad Vendida", "Total Venta")
        self.tabla.column("#0", width=0)
        self.tabla.heading("ID", text="ID")
        self.tabla.heading("Titulo Libro", text="Titulo Libro")
        self.tabla.heading("Fecha", text="Fecha")
        self.tabla.heading("Cantidad Vendida", text="Cantidad Vendida")
        self.tabla.heading("Total Venta", text="Total Venta")
